...
export class TransactionPayloadCall extends TransactionPayload {
  constructor(public readonly value: Call) {
    super();
  }
  ...
  static load(deserializer: Deserializer): TransactionPayloadCall {
    const value = Script.deserialize(deserializer);
    return new TransactionPayloadCall(value);
  }
}

export class TransactionPayloadContractBundle extends TransactionPayload {
  ...
  static load(deserializer: Deserializer): TransactionPayloadContractBundle {
